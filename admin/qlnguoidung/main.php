...
<div>
	<div  class="quanly" style="background-color:LawnGreen">
		<h3><strong><center>QUẢN LÝ NGƯỜI DÙNG</strong></center></h3>
	</div><hr>
 ...
 <?php
  ...
  <table id="banhang" class="table table-hover">
        <thead>
		<tr>
			<th bgcolor="yellow"><a href="index.php?sort=hoten">Họ tên</a></th>
			<th bgcolor="yellow"><a href="index.php?sort=email">Email</a></th>
			<th bgcolor="yellow"><a href="index.php?sort=loai"></a>Số điện thoại</th>
			<th bgcolor="yellow"><a href="index.php?sort=ngaysinh">Loại quyền</a></th>			
			<th bgcolor="yellow">Trạng thái</th>
			<th bgcolor="yellow">Khóa</th>
 ...
 <center><a class="btn btn-warning" data-toggle="modal" data-target="#fthemnguoidung"><span class="glyphicon glyphicon-plus"></span> Thêm người dùng</a></center>
