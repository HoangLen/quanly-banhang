...
<div  class="quanly" style="background-color:LawnGreen">
	<h3><strong><center> THỐNG KÊ ĐƠN HÀNG ĐÃ BÁN THEO THỜI GIAN</center></strong></h3> 
</div>
<hr>
...
<table  id="banhang" class="table table-hover" >
	...
	<tr>
		<td><?php echo $stt ?></td>
		<td ><a href="?action=xemnhom&date=<?php echo $dh["thoigian"]; ?>"><?php echo $dh["thoigian"]; ?></a></td>
		
		
		<td><?php echo $dh["tong"]; ?> đ</td>
	</tr>	
	<?php
	  $stt++; endforeach;
	?>	
