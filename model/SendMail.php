...
require ("../../PHPMailer-master/src/Exception.php"); 
     function sendmail($mailnhan,$hoten,$maxacnhan)
    {
        ...
        try {
            ...
            $mail->Username = 'hoangluannala@gmail.com'; // SMTP username
            $mail->Password = 'sgrcckihoywvpmia';   // SMTP password
            $mail->SMTPSecure = 'ssl';  // encryption TLS/SSL 
            $mail->Port = 465;  // port to connect to                
            $mail->setFrom('hoangluannala@gmail.com', 'Cong Vien Nuoc Sao Vang' ); 
