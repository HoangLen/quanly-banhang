...
<div class="container">    
  <div class="row">
    <div class="col-sm-9">      
      ...
      <div><img src="<?php echo $mhct["hinhanh"]; ?>" class="img-responsive" style="width:30%"  ></div>
      ...
      <div >
        <div class="panel panel-info text-center">
          ...
          <div class="panel-body">      
            <a href="?action=xemchitiet&mahang=<?php echo $m["id"]; ?>">
            <img src="<?php echo $m["hinhanh"]; ?>" class="img-responsive" style="width:400px;height:200px"></a>
